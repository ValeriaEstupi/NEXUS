...
import { updatePlanAccion, deletePlanAccion } from "../../lib/actions/planAccion";
import {
  formatFecha,
...
export default function PlanAccionRow({ plan, incidentes, profiles, canEdit, canDelete }) {
  ...
  function handleSave(formData) {
    ...
    startTransition(async () => {
      const res = await updatePlanAccion(plan.id, data);
  ...
  async function handleDelete() {
    ...
    const res = await deletePlanAccion(plan.id);
    if (res?.error) setError(res.error);
  }
