...
import { createPlanAccion } from "../../lib/actions/planAccion";
import { PLAN_ACCION_ORIGEN_LABEL } from "../../lib/helpers";

export default function NewPlanAccionForm({ incidentes, profiles }) {
  ...
  function handleSubmit(formData) {
    ...
    startTransition(async () => {
      const res = await createPlanAccion(data);
