...
import { createIncidente } from "../../lib/actions/incidentes";
import { CLASIFICACION_INCIDENTE_LABEL } from "../../lib/helpers";

export default function NewIncidenteForm({ vehiculos, conductores }) {
  ...
  function handleSubmit(formData) {
    ...
    startTransition(async () => {
      const res = await createIncidente(data);
