...
import { createCapacitacion } from "../../lib/actions/capacitaciones";
import { CAPACITACION_TIPO_LABEL } from "../../lib/helpers";

export default function NewCapacitacionForm({ conductores }) {
  ...
  function handleSubmit(formData) {
    ...
    startTransition(async () => {
      const res = await createCapacitacion(data);
