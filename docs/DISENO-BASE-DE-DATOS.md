# Cómo está diseñada la base de datos de NEXU
...
cada persona dentro de NEXU: `lector`, `editor` o `super_admin`. Se
...
## 5. `cumplimiento_items` — el "cómo vamos" (el corazón de NEXU)
...
NEXU es una herramienta **interna de una sola empresa** (no
