...
NEXU se construyó pensando en la reglamentación colombiana que aplica
...
- **Estructura que usa NEXU**: 5 pilares (gestión institucional,
...
- **Qué NO es el seed de NEXU**: los ~35 requisitos precargados
...
- **Qué hacer antes de auditar con esto**: contrastar cada requisito
  ...
  desde la pantalla de PESV en NEXU.
...
- **Grupo de estándares que usa NEXU**: el set completo de 60 ítems
...
- **Qué NO es el seed de NEXU**: la redacción de cada estándar y su
...
## Por qué NEXU se construyó así (y no con el texto "cerrado")
...
legal/HSEQ de la empresa — NEXU es la herramienta de seguimiento, no
